...
if("FALSE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/mpc/Multi_Car_Parking/workspace/src/test)
  set(test_DEVEL_PREFIX /home/mpc/Multi_Car_Parking/workspace/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/mpc/Multi_Car_Parking/workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mpc/Multi_Car_Parking/workspace/install/${idir}'.  ${_report}")
    endif()
...
set(depends "parking;rospy;std_msgs")
